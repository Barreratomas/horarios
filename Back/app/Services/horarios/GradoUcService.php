...
class GradoUcService implements GradoUcRepository
{
    ...
    public function obtenerGradoUcPorIdGradoConRelaciones($id_carrera_grado)
    {
        try {
            // Obtén los registros de grado_uc junto con las relaciones grado y unidadCurricular
            $gradoUC = GradoUC::with(['carreraGrado', 'unidadCurricular'])
    ...
    public function actualizarGradoUC($id_grado, array $materias)
    {
        try {
            ...
            $materiasExistentes = GradoUC::where('id_carrera_grado', $id_grado)->pluck('id_uc')->toArray();
            ...
            foreach ($materiasAEliminar as $materiaId) {
                ...
                GradoUC::where('id_carrera_grado', $id_grado)
